...
import com.comment.tek.activity.BuildConfig;
import com.comment.tek.bean.LzyResponse;
import com.comment.tek.bean.SimpleResponse;
        ...
        if (rawType != LzyResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                if (code == 200) {
                    ...
                    //用handler回调到ui线程去执行
//                    BaseApplication.getInstance().getHandler().sendEmptyMessage(BaseApplication.MSG_TOKEN_EXPIRES);
                } else {
