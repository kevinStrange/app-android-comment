package com.comment.banner.view;
...
import com.comment.banner.loader.ImageLoaderInterface;
import com.comment.banner.util.BannerConfig;
import com.comment.banner.util.WeakHandler;

import java.lang.reflect.Field;
import java.util.ArrayList;
import java.util.List;

import activity.comment.com.banner.R;
...
//        Log.i(tag,"currentItem: "+currentItem);
     ...
     * @return
     */
    public Banner setOnBannerListener(IOnBannerListener listener) {
